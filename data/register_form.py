...
class RegisterForm(FlaskForm):
    ...
    bd = DateField('Birth day(Y-m-d)(optional)')
    address = StringField('Address', validators=[DataRequired()])
    phone_number = StringField('Phone_number(optional)', validators=[validate_phone])
    description = StringField('Description(optional)', validators=[Length(max=255, message='Description can not exceed 255 symbols')])
